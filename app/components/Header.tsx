            ...
            <div className="flex items-center justify-between">
                ...
                <div className="relative flex items-center ">
                    <div className="h-10 w-10 rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10 mr-20">
                        <a href="" className="block w-full h-full">
                            <span className="sr-only">PhD. MAHAMAT ADOUM ABDOULAYE</span>
                            <Image 
                ...
                <div className="items-center justify-between flex-1 hidden sm:flex">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <LanguageSwitcher></LanguageSwitcher>
                        {/* Language Switcher */}
                        <a href="https://www.linkedin.com/in/mahamat-adoum-abdoulaye-1a590599/" className="transition text-zinc-500 hover:text-[#0a66c2]">
                        ...
                        <a href="mailto:mahamatadoumabdoulaye1@gmail.com" className="inline-block px-4 py-2 text-sm font-medium leading-5 transition rounded-full shadow-lg ring-1 backdrop-blur bg-white/90 shadow-zinc-800/5 ring-zinc-900/5 dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20 hover:text-primary hover:font-bold">
                            {t('menu.mail')}
                        </a>
                    </div>
                </div>
